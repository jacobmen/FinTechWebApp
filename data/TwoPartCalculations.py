...
def twoPartIR(dividend, payInterval, cRatio, irRate1, irRate2, length1, length2):
    ...
    numPayments2 = int(length2 * rPayInterval)  # the # of payments in interval 2
    intervalInt = int(payInterval * rPayInterval)  # scaling # payments
    interest1 = (1 + irRate1 / 100)  # convert interest from percent to modifier
    interest2 = (1 + irRate2 / 100)  # convert common ratio 1 from percent to modifier
    commonR = (1 + cRatio / 100)  # convert common ratio 2 from percent to modifier
